 ...
 * @author Juanpq
 */
public class LowConstant extends Gate {
    public LowConstant(int x, int y, int w, int h) {
        super(1);
        this.x = x;
        this.y = y;
        this.width = w;
    ...
    public void Draw(Graphics g){
        ...
        g.drawString("False", x+ width/2, y + height/2);
    ...
    protected String eval() {
        return "El valor de salida es False";
    }
